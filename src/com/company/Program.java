...
public class Program {
    public static void main(String[] args) {
        ...
        String[] wordList = {"airports", "sind", "doof", "oh", "nana", "what"};
    ...
    private static int countWordOccurrence(String sentence, String searchedWord) {
        ...
        boolean contains = Arrays.asList(arraySearchedWord).contains(searchedWord);
        ...
        for(int i = 0; i <  sentence.length() - 1; i++){
            ...
            /*if(searchedWord.equalsIgnoreCase(arraySearchedWord[i])) {
               counter++;
               System.out.println(searchedWord + " kommt " + counter + " mal vor.");
              // System.out.printf(searchedWord + " kommt %d mal vor.", counter);
           }*/
        }
        System.out.println(searchedWord + " kommt " + counter + " mal vor.");
